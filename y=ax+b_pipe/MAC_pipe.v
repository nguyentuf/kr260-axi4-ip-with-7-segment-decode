module MAC #(
    ...
    //-----------------------------------------//
    reg [WDATA_DWIDTH-1:0]       A_r, X_r, B_r,P_r,B_delay_r;
    reg [WDATA_DWIDTH-1:0]       Y_r; 
    ...
    assign complete_flag_w = (current_state_r == s_EXEC && wait_flag_r) ? 1'b1 : 1'b0; 
